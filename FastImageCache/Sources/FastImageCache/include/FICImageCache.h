...
@property(class, nonatomic, readonly) FICImageCache *shared;
...
@property(class, nonatomic, readonly) dispatch_queue_t dispatchQueue;
...
- (void)deleteImagesForEntity:(id <FICEntity>)entity;
