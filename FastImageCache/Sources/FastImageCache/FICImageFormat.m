...
- (CGSize)pixelSize {
    return CGSizeMake(_imageSize.width * _scale,  _imageSize.height * _scale);
}
...
+ (instancetype)formatWithName:(NSString *)name family:(NSString *)family imageSize:(CGSize)imageSize scale:(CGFloat)scale style:(FICImageFormatStyle)style maximumCount:(NSInteger)maximumCount devices:(FICImageFormatDevices)devices protectionMode:(FICImageFormatProtectionMode)protectionMode {
...
- (NSDictionary *)dictionaryRepresentation {
    ...
    [dictionaryRepresentation setValue:[NSNumber numberWithUnsignedInteger: _style] forKey:FICImageFormatStyleKey];
    [dictionaryRepresentation setValue:[NSNumber numberWithUnsignedInteger:_maximumCount] forKey:FICImageFormatMaximumCountKey];
    [dictionaryRepresentation setValue:[NSNumber numberWithInteger:_devices] forKey:FICImageFormatDevicesKey];
    ...
    [dictionaryRepresentation setValue:[NSNumber numberWithFloat:_scale] forKey:FICImageTableScreenScaleKey];
...
- (id)copyWithZone:(NSZone *)zone {
    ...
    [imageFormatCopy setScale:[self scale]];
